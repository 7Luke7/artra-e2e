...
for entry in package.json package-lock.json app.config.js jsconfig.json src public; do
...
echo " - staged $(find "$STAGE/src" -type f | wc -l) source file(s) into .artra-build/"
